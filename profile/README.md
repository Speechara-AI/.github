...
<p align="center">
  ...
  <a href="https://github.com/Speechara-AI/.github/discussions"><img src="https://img.shields.io/badge/Community-Обсуждения-222?style=for-the-badge&logo=github&logoColor=white" alt="Discussions" /></a>
...
| Платформа | Репозиторий | Ссылка на релизы |
|---|---|---|
| macOS | `speechara_mac_app` | [посмотреть](https://github.com/Speechara-AI/speechara_mac_app/releases) |
| Windows | `speechara_win_app` | [посмотреть](https://github.com/Speechara-AI/speechara_win_app/releases) |
| Backend API | `speechara_be` | [посмотреть](https://github.com/Speechara-AI/speechara_be/releases) |

## Где публикуем обновления

- [Releases](https://github.com/Speechara-AI/.github/releases) — официальные версии и заметки к ним
- [Discussions](https://github.com/Speechara-AI/.github/discussions) — новости, идеи, вопросы и обратная связь
- [Вопросы по продукту](https://github.com/Speechara-AI/.github/discussions/categories) — раздел для поддержки

## Как с нами связаться

- Сайт: https://speechara.ai
- X: https://x.com/getspeechara
- LinkedIn: https://www.linkedin.com/company/speechara
- Facebook: https://www.facebook.com/app.speechara
- Email: info@speechara.ai

---

**Speechara.AI** — меньше шума в переговорах, больше ясности в решениях.